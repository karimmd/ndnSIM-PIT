...
//================ CUSTOM DEFINED FUNCTIONS ================================== 
 /*
  ...
  std::cout<< "node " << node << " get interest with field value " << interest.getBetw() << std::endl;    
 */
//=============================================================================
  ...
  if (!pitEntry->hasInRecords()) {
    if (m_csFromNdnSim == nullptr) {
      ...
      if (match != nullptr) {
        ...
        std::cout << " Content2 Interest :" << std::endl;
      }
      else {
...
///////////////////////Custom//////////////////////////////
void
Forwarder::setPIT(const shared_ptr<pit::Entry>& pitEntry, Face& outFace, const Interest& interest)
{
  NFD_LOG_DEBUG("onOutgoingInterest face=" << outFace.getId() <<
                " interest=" << pitEntry->getName());
...
//  int node = ns3::Simulator::GetContext();  
 // std::cout<< " Face " << inFace.getId() << " get data with field value " << data.getName()<< std::endl;    

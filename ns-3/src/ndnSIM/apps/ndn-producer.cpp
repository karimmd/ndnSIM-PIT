...
Simulator::Schedule(Seconds(0.1),&Producer::contentProducer, this, "/"+std::to_string(GetNode()->GetId())+"/"+std::to_string(i));
   }
...
void 
Producer::contentProducer(std::string pp){
 ndn::FibHelper::AddRoute(GetNode(), pp , m_face, 0);
}
void

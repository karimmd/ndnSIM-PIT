...
set ylabel "Throughput Rate (Mbps)" offset 2,0

# line Plot Statement
#plot "throughput.dat" using 1:($2/1000)/1000 title "Our Implementation" ls 7 lw 2 smooth cspline, '' using 1:($3/1000)/1000 title "Traditional NDN" ls 2 lw 2 smooth cspline

# histograms Plot Statement

plot "throughput.dat"  using ($2/1000)/1000:xtic(1) title "Our Implementation" ls 7, '' using ($3/1000)/1000 title "Traditional NDN" ls 2

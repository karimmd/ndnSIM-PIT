...
# line Plot Statement
plot "flow.dat" using 1:2 title "100 contents per consumer" ls 7 lw 2 smooth cspline, '' using 1:3 title "200 contents per consumer" ls 8 lw 2 smooth cspline, '' using 1:4 title "300 contents per consumer" ls 6 lw 2 smooth cspline
